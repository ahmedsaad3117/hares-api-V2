...
export class SeedQ1KeyLandingPageContent1785360000000
  implements MigrationInterface
{
  name = "SeedQ1KeyLandingPageContent1785360000000";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      [
        ...
        "منصة متخصصة لمتابعة البيع والأنشطة التجارية والآجل والتحصيل للمؤسسات والمنشآت الصغيرة بطريقة سهلة وذكية وآمنة وسرية عالية لمعلومات العملاء.",
        "A specialized platform for tracking sales, business activities, credit, and collections for institutions and small businesses — simple, smart, secure, and highly confidential for customer data.",
        "تسجيل الدخول",
        "Login",
        "اشترك الآن",
        "Subscribe Now",
        ...
        "تواصل معنا",
        "Contact Us",
        JSON.stringify(["hero", "features", "plans", "about", "contact"]),
    ...
    for (const plan of plans) {
      await queryRunner.query(
        `
          ...
          VALUES ($1, $2, $3, $4, $5, true, false, $6, NULL, NOW(), NOW())
          ON CONFLICT ("id") DO UPDATE SET
            "name" = EXCLUDED."name",
